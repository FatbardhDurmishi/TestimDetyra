...
namespace TestimDetyra.TestScenarios.PlayListFunctionalityYoutube
{
    public class SaveVideoToPlaylist
    {
        ...
        public void SaveVideoToNewPlaylist()
        {
            ...
            Thread.Sleep(2000);
            Driver.driver.FindElement(By.XPath("/html/body/ytd-app/ytd-popup-container/tp-yt-paper-dialog/ytd-add-to-playlist-renderer/div[3]/ytd-add-to-playlist-create-renderer/ytd-compact-link-renderer/a/tp-yt-paper-item")).Click();
            Thread.Sleep(2000);
